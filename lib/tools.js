 ...
 *
 * @param {Object | String} options Object | String indicating the {@link module:request~options}. Passing a String (aka the shorthand options) is handled as `options = {url: options}`.
