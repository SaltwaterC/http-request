...
/**
 * Wrapper for formatting the message of an TypeError object
 *
 * @private
 * @param {String} message The TypeError message
 ...
 */
exports.formattedTypeError = function() {
	return new TypeError(util.format.apply(this, arguments));
};
