 ...
 *
 * @param {Mixed} options String | Object indicating the options. Passing a String (aka the shorthand options) is handled as `options = {url: options}`.
 * @param {String} method Indicates the HTTP method for the request
 * @returns {Object} An options Object to be used by {@link module:request~Request}
 */
 ...
 *
 * @param {String} message The message which is dumped to STDERR via [util.debug](http://nodejs.org/api/util.html#util_util_debug_string)
 */
